        ...
        <div className="w-80 sm:w-72 md:w-72 lg:w-56 xl:w-64 p-2 mt-10 lg:mt-6 flex flex-col gap-6">
            <div className="card group">
                <HeroCard
                    ...
                    image={"https://i.ibb.co/P1s75B2/Default-beautiful-shoe-nike-for-website-background-image-with-0-2.jpg"}
                />
            </div>
            <div className="card group">
                <HeroCard
                    heading={'Nike Dunk shoes'}
                    image={"https://i.ibb.co/19c6P4t/Default-beautiful-shoe-nike-for-website-background-image-with-0-1-2.jpg"}
                />
            </div>
            <div className="card">
